...
def ids():
    ...
    for depth in range(
        ...
        path, exploration, found = (
            depth_limited_search(
                depth
            )
        )

        all_exploration.extend(
            exploration
        )
...
def solve_algorithm(
    ...
    if algorithm == "BFS":
        ...
        path, exploration = ids()

    elif algorithm == "Best-First":

        path, exploration = best_first()

    elif algorithm == "A*":

        path, exploration = astar()
